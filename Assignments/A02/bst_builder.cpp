...
int findMean(int bstInput[], int n) 
{ 
    int sum = 0; 
    for (int i = 0; i < n; i++)  
        sum += bstInput[i]; 
...
const int SIZE = 12; //Size declaration of array
int bstInput[SIZE]; //Array declaration
...
//Read numbers from file into the array
        ...
        infile >> bstInput[count];
        B.insert(bstInput[count]);
    }
